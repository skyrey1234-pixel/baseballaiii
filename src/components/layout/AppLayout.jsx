...
import { LayoutGrid, Swords, Crosshair, Users, Diamond, Clapperboard, FlaskConical, Activity, Dna, Boxes } from "lucide-react";
...
const nav = [
  ...
  { to: "/swing-studio", label: "Swing Studio", icon: Boxes },
