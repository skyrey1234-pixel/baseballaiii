    ...
    <div className="rounded-2xl border border-white/5 bg-[#0C1220] overflow-hidden">
      ...
      <div className="p-5">
        ...
        <div className="mt-4 flex items-center gap-3">
          <Button onClick={analyze} disabled={analyzing} size="sm" className="bg-emerald-500 hover:bg-emerald-400 text-[#06110C] font-semibold">
            {analyzing ? <><Loader2 className="w-4 h-4 mr-2 animate-spin" /> Analyzing…</> : <><Sparkles className="w-4 h-4 mr-2" /> {film.analysis ? "Re-analyze" : "AI breakdown"}</>}
          </Button>
          {film.analysis && (
